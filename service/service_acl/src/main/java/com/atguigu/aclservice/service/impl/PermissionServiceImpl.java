...
//        });
    ...
    //封装成需要的结构
    private List<Permission> bulidPermission(List<Permission> permissionList) {
        //1创建List集合，存放返回数据
        List<Permission> trees = new ArrayList<>();
        //2遍历所有菜单集合
        for (Permission permission : permissionList) {
            ...
            if("0".equals(permission.getPid())){
                ...
                //2.3把值放到最终list集合
                trees.add(findPermissionChildren(permission,permissionList));
            }
    ...
    //递归实现封装子级别数据
    private Permission findPermissionChildren(Permission permission, List<Permission> permissionList) {
        //1初始化值
        ...
        for (Permission it : permissionList) {
            ...
            if(permission.getId().equals(it.getPid())){
                ...
                //2.3递归调用存入数据
                permission.getChildren().add(findPermissionChildren(it,permissionList));
            }
